...
`lote` admite cualquier entero entre 2 y 10, incluidos ambos límites. Toma únicamente las siguientes causas con estado `PENDIENTE` en el SQLite de la configuración seleccionada.
...
Para revisar 20, 50 o 100 causas en bloques controlados, ejecute varios lotes de 10 de forma consecutiva, comprobando `estado` entre cada bloque. No inicie varias ventanas en paralelo.
