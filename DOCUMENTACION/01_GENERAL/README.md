...
├── DOCUMENTACION/                    # Documentación clasificada del proyecto
│   ├── 01_GENERAL/                   # README, visión, manual y contexto
│   ├── 02_MODULOS_Y_CONFIGURACION/   # Reglas, módulos y configuración
│   ├── 03_PLANES/                    # Planes de implementación y corrección
│   ├── 04_DIAGNOSTICOS_Y_CORRECCIONES/ # Análisis y correcciones puntuales
│   └── 05_AVANCES/                   # Checkpoints históricos
