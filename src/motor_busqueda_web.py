...
class BotJudicial:
    ...
    def _aplicar_inferencia_consolidada(self, datos, causa=None, demandados=None):
        ...
        logger.info(
            "[DECISION_FASE_FINAL] %s",
            json.dumps(
                {
                    "causa": causa,
                    "origen": datos.get("ORIGEN_DATA", "CONSOLIDADO_CARPETAS"),
                    "fase_final": inferencia.get("ULTIMA_FASE"),
                    "etapa_final": inferencia.get("ULTIMA_ETAPA"),
                    "fecha_final": inferencia.get("FECHA_FIN_ULTIMA_FASE"),
...
class BotJudicialTransaccional(BotJudicial):
    ...
    def _consolidar_resultados_carpetas(self, causa, resultados):
        ...
        if datos["HISTORIAL_ACTUACIONES"]:
            self._aplicar_inferencia_consolidada(
                datos, causa=causa, demandados=demandados_satje
            )
        if fechas_inicio:
